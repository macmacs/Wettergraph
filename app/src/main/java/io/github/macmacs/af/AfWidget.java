...
public class AfWidget extends AppWidgetProvider {
    ...
    public void onAppWidgetOptionsChanged(Context context, AppWidgetManager appWidgetManager, int appWidgetId, Bundle newOptions) {
        ...
        new Thread(() -> {
            try {
                io.github.macmacs.af.AfSettings.saveExactDimensions(context, appWidgetId, portW_px, portH_px, landW_px, landH_px);

                Uri widgetUri = ContentUris.withAppendedId(io.github.macmacs.af.AfProvider.AfWidgets.CONTENT_URI, appWidgetId);
